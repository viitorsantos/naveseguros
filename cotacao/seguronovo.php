	...
	<div class="container">
		...
		<form method="POST" enctype="multipart/form-data" action="perfil.php">
			<div class="centro">
				...
				<p>Envie uma foto do documento do veículo OU Digite os dados do veículo </p>
				<div class='row'>
					...
					<div class='col-md-2'>	
						<div class="form-group">
							...
							<input type="checkbox"> Veículo sem placa ?
						</div>
					</div>
					<div class='col-md-2'>	
						<div class="form-group">
				...
				<div class='row'>
					...
					<div class='col-md-2'>	
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Exemplo 2017/2018">
						</div>
					</div>
				</div>
				<br>
