<?php
	...
	if(isset($_POST['btnacao'])){
		...
		$sql = "SELECT id_usuario, nome, login, senha, ativo FROM tbl_usuario WHERE login = '$login_digitado' 
		AND ativo = 1";
  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" method="POST" action="">
        <h2 class="form-signin-heading text-center">Login Nave Seguros</h2>
